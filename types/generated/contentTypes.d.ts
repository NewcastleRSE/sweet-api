...
export interface ApiMetaMeta extends Struct.CollectionTypeSchema {
...
export interface ApiProfilerProfiler extends Struct.CollectionTypeSchema {
  collectionName: 'profilers';
  info: {
    displayName: 'profiler';
    pluralName: 'profilers';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateComplete: Schema.Attribute.Date;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    contact_preference: Schema.Attribute.Enumeration<['sms', 'email']>;
